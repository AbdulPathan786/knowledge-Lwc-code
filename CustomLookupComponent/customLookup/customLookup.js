...
import searchLookupRecords from '@salesforce/apex/CustomLookupController.searchLookupRecords'; // Apex method 
import getRecentlyViewed from '@salesforce/apex/CustomLookupController.getRecentlyViewed'; // Apex method 
import getRecentlyCreatedRecord from '@salesforce/apex/CustomLookupController.getRecentlyCreatedRecord'; // Apex method 
...
export default class CustomLookup extends LightningElement {
    ...
    @api placeholder; // Being used for input place holder.
    ...
    */
    ...
    getRecentlyViewedRecords() {
        ...
        //console.log('getRecentlyViewed parameters : ',parameters);
        getRecentlyViewed(JSON.parse(JSON.stringify(parameters))).then(results => {
            this.searchResults = results;
            // console.log('this.searchResults : ',this.searchResults);
            this.noRecordFound = (results.length == 0);
        }).catch(error => {
